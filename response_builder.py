...
def resolve_agent_output(
    ...
    result: Any,
) -> Tuple[str, Optional[dict], Optional[dict], Optional[dict]]:
    """
    ...
    if not user_context:
        return fallback, result_chart, None, None
    ...
    return response_text, chart_data, agp_chart_data, ehba1c_tir_data